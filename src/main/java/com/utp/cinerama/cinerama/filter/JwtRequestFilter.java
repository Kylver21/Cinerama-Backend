package com.utp.cinerama.cinerama.filter;
 ...
 * 
 * FLUJO:
 * 1. Extrae el token del header Authorization o de cookies
 * 2. Valida el token y extrae el username
 * 3. Carga los detalles del usuario desde la base de datos
 * 4. Si es válido, autentica al usuario en el SecurityContext
